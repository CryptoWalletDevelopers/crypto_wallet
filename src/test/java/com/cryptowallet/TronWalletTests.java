...
public class TronWalletTests {
    ...
    public void init(){
        ...
        userServiceFacade.saveUser(user1);
    ...
    public void testEckey(){
       ...
       ECKey key2 =  tronWallet.getECkey(3,2);
        Assert.assertEquals("pub:04de327150021b965f0a2e3a7377c3e5e450fc2fa5e6064ee2cf17d390878fa38afe707835222fa59c2d7fe346ade529c68b2006a59b8a1c9b5dc7931ae6578ac7", key1.toString());
        Assert.assertEquals("pub:043836745abeb3554bc37c564fa19bc4076ca0264a4c3e87fb369adbe013d6fe8e3825d466a008575d783c6d91ffedc0a20436d1f0610d5682728c9a4d37e89ee8", key2.toString());
    }
    ...
    public void getPrivateKeyBytesTest(){
        ...
        Assert.assertEquals("74707276386b36785234414261764832744d4633684163376f526e7842774376", priv1);
        Assert.assertEquals("74707276386a4b72503738777057647446316a6447575045555a4b314d68426e", priv2);
    }
    ...
    public void getStringAddressTest(){
        ...
        Assert.assertEquals("TKmdnkRurAxJyd1VeE8BLGmY5oaH2UBfLn", address1);
        Assert.assertEquals("TPUPh49r9pooibFTJQcFWKQAren6Uo1FDX", address2);
    }
